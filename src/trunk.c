...
//TODO: use enums
static CONST_DATA unsigned char gNextUpOptionInTrunkSubmenu[] = {0, 0, 1};
static CONST_DATA unsigned char gNextDownOptionInTrunkSubmenu[] = {1, 2, 2};
static CONST_DATA unsigned char gUnk_8DF8142[] = {72, 88, 104}; //cursor y coords
static CONST_DATA unsigned char gUnk_8DF8145[] = {56, 56, 56}; //cursor x coords
