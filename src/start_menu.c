...
extern unsigned char gStartMenuBgTiles[]; //(also status menu tiles; only the palette is updated)
...
extern unsigned short gUnk_8079424[]; //text palette
extern unsigned short gUnk_8079444[][30]; // bg tilemap
