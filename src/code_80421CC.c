...
static CONST_DATA unsigned char gText_Deckcards[] = _(
  "{ENG}"
    "0123456789　ＬＰDeckcards "
  "{FRE}"
    "0123456789　ＬＰDeckcartes"
  "{GER}"
    "0123456789　ＬＰDeckKarten"
  "{ITA}"
    "0123456789　ＬＰDeckcarte "
  "{SPA}"
    "0123456789　ＬＰDeckcartas"
  "{JAP}"
    "0123456789　ＬＰデッキのこりまい"
);

static CONST_DATA unsigned char gText_DetailsTurnEndDiscard[] = _(
  "{ENG}"
...
static CONST_DATA unsigned short g8E0D91A[] = {0xE8C4, 0xE944, 0xE8D8, 0xE958};
...
_08042754: .4byte gText_Deckcards\n\
...
static void InitBMenu (unsigned char arg0) {
  ...
  if (r0 >= r4two)
    ...
    r0 = 0;
  ConvertU16ToDigitBuffer(r0, DIGIT_FLAG_NONE);
...
static void sub_8042D14 (void) {
  ...
  for (i = 0; i < 5; i++) {
    for (j = 0; j < 5; j++) {
      ...
      *r4++ = gDigitBufferU16[0] + 0x303D;
      *r4++ = gDigitBufferU16[1] + 0x303D;
      *r4++ = gDigitBufferU16[2] + 0x303D;
      *r4++ = gDigitBufferU16[3] + 0x303D;
      *r4 = gDigitBufferU16[4] + 0x303D;
      r4 += 28;
