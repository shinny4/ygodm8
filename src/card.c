...
/*
  TODO: consider various naming schemes such as
    g<TypeName><Language>Tiles
    g<Language><TypeName>Tiles
    etc...
*/

//TODO: rename to sCardType... attribute etc...
//or    remove "Type" prefix?
//although it can be confusing when there is a type and attribute with the same name
//such as Aqua

static const unsigned char TypeDragonTiles[] = INCBIN_U8("graphics/cards/types/dragon.4bpp");
static const unsigned char TypeMagicianTiles[] = INCBIN_U8("graphics/cards/types/magician.4bpp");
static const unsigned char TypeZombieTiles[] = INCBIN_U8("graphics/cards/types/zombie.4bpp");
static const unsigned char TypeWarriorTiles[] = INCBIN_U8("graphics/cards/types/warrior.4bpp");
static const unsigned char TypeBeastwarriorTiles[] = INCBIN_U8("graphics/cards/types/beast_warrior.4bpp");
static const unsigned char TypeBeastTiles[] = INCBIN_U8("graphics/cards/types/beast.4bpp");
static const unsigned char TypeWingbeastTiles[] = INCBIN_U8("graphics/cards/types/wing_beast.4bpp");
static const unsigned char TypeFiendTiles[] = INCBIN_U8("graphics/cards/types/fiend.4bpp");
static const unsigned char TypeFairyTiles[] = INCBIN_U8("graphics/cards/types/fairy.4bpp");
static const unsigned char TypeInsectTiles[] = INCBIN_U8("graphics/cards/types/insect.4bpp");
static const unsigned char TypeDinosaurTiles[] = INCBIN_U8("graphics/cards/types/dinosaur.4bpp");
static const unsigned char TypeReptileTiles[] = INCBIN_U8("graphics/cards/types/reptile.4bpp");
static const unsigned char TypeFishTiles[] = INCBIN_U8("graphics/cards/types/fish.4bpp");
static const unsigned char TypeSeadragonTiles[] = INCBIN_U8("graphics/cards/types/sea_dragon.4bpp");
static const unsigned char TypeMachineTiles[] = INCBIN_U8("graphics/cards/types/machine.4bpp");
static const unsigned char TypeThunderTiles[] = INCBIN_U8("graphics/cards/types/thunder.4bpp");
static const unsigned char TypeAquaTiles[] = INCBIN_U8("graphics/cards/types/aqua.4bpp");
static const unsigned char TypePyroTiles[] = INCBIN_U8("graphics/cards/types/pyro.4bpp");
static const unsigned char TypeRockTiles[] = INCBIN_U8("graphics/cards/types/rock.4bpp");
static const unsigned char TypePlantTiles[] = INCBIN_U8("graphics/cards/types/plant.4bpp");
static const unsigned char TypeEnglishSpellTiles[] = INCBIN_U8("graphics/cards/types/english_spell.4bpp");
static CONST_DATA unsigned char TypeFrenchSpellTiles[] = INCBIN_U8("graphics/cards/types/french_spell.4bpp");
static CONST_DATA unsigned char TypeGermanSpellTiles[] = INCBIN_U8("graphics/cards/types/german_spell.4bpp");
static CONST_DATA unsigned char TypeItalianSpellTiles[] = INCBIN_U8("graphics/cards/types/italian_spell.4bpp");
static CONST_DATA unsigned char TypeSpanishSpellTiles[] = INCBIN_U8("graphics/cards/types/spanish_spell.4bpp");
static const unsigned char TypeEnglishTrapTiles[] = INCBIN_U8("graphics/cards/types/english_trap.4bpp");
static CONST_DATA unsigned char TypeFrenchTrapTiles[] = INCBIN_U8("graphics/cards/types/french_trap.4bpp");
static CONST_DATA unsigned char TypeGermanTrapTiles[] = INCBIN_U8("graphics/cards/types/german_trap.4bpp");
static CONST_DATA unsigned char TypeItalianTrapTiles[] = INCBIN_U8("graphics/cards/types/italian_trap.4bpp");
static CONST_DATA unsigned char TypeSpanishTrapTiles[] = INCBIN_U8("graphics/cards/types/spanish_trap.4bpp");
static const unsigned char TypeEnglishRitualTiles[] = INCBIN_U8("graphics/cards/types/english_ritual.4bpp");
static CONST_DATA unsigned char TypeFrenchRitualTiles[] = INCBIN_U8("graphics/cards/types/french_ritual.4bpp");
static CONST_DATA unsigned char TypeGermanRitualTiles[] = INCBIN_U8("graphics/cards/types/german_ritual.4bpp");
static CONST_DATA unsigned char TypeItalianRitualTiles[] = INCBIN_U8("graphics/cards/types/italian_ritual.4bpp");
static CONST_DATA unsigned char TypeSpanishRitualTiles[] = INCBIN_U8("graphics/cards/types/spanish_ritual.4bpp");

static const unsigned char g808FA10[] = INCBIN_U8("graphics/cards/attributes/english_shadow.4bpp");
static CONST_DATA unsigned char gAttributeShadowFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_shadow.4bpp");
static CONST_DATA unsigned char gAttributeShadowGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_shadow.4bpp");
static CONST_DATA unsigned char gAttributeShadowItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_shadow.4bpp");
static CONST_DATA unsigned char gAttributeShadowSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_shadow.4bpp");

static const unsigned char g808FA90[] = INCBIN_U8("graphics/cards/attributes/english_light.4bpp");
static CONST_DATA unsigned char gAttributeLightFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_light.4bpp");
static CONST_DATA unsigned char gAttributeLightGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_light.4bpp");
static CONST_DATA unsigned char gAttributeLightItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_light.4bpp");
static CONST_DATA unsigned char gAttributeLightSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_light.4bpp");

static const unsigned char g808FB10[] = INCBIN_U8("graphics/cards/attributes/english_fiend.4bpp");
static CONST_DATA unsigned char gAttributeFiendFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_fiend.4bpp");
static CONST_DATA unsigned char gAttributeFiendGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_fiend.4bpp");
static CONST_DATA unsigned char gAttributeFiendItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_fiend.4bpp");
static CONST_DATA unsigned char gAttributeFiendSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_fiend.4bpp");

static const unsigned char g808FB90[] = INCBIN_U8("graphics/cards/attributes/english_dream.4bpp");
static CONST_DATA unsigned char gAttributeDreamFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_dream.4bpp");
static CONST_DATA unsigned char gAttributeDreamGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_dream.4bpp");
static CONST_DATA unsigned char gAttributeDreamItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_dream.4bpp");
static CONST_DATA unsigned char gAttributeDreamSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_dream.4bpp");

static const unsigned char g808FC10[] = INCBIN_U8("graphics/cards/attributes/english_pyro.4bpp");
static CONST_DATA unsigned char gAttributePyroFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_pyro.4bpp");
static CONST_DATA unsigned char gAttributePyroGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_pyro.4bpp");
static CONST_DATA unsigned char gAttributePyroItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_pyro.4bpp");
static CONST_DATA unsigned char gAttributePyroSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_pyro.4bpp");

static const unsigned char g808FC90[] = INCBIN_U8("graphics/cards/attributes/english_forest.4bpp");
static CONST_DATA unsigned char gAttributeForestFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_forest.4bpp");
static CONST_DATA unsigned char gAttributeForestGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_forest.4bpp");
static CONST_DATA unsigned char gAttributeForestItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_forest.4bpp");
static CONST_DATA unsigned char gAttributeForestSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_forest.4bpp");

static const unsigned char g808FD10[] = INCBIN_U8("graphics/cards/attributes/english_wind.4bpp");
static CONST_DATA unsigned char gAttributeWindFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_wind.4bpp");
static CONST_DATA unsigned char gAttributeWindGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_wind.4bpp");
static CONST_DATA unsigned char gAttributeWindItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_wind.4bpp");
static CONST_DATA unsigned char gAttributeWindSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_wind.4bpp");

static const unsigned char g808FD90[] = INCBIN_U8("graphics/cards/attributes/english_earth.4bpp");
static CONST_DATA unsigned char gAttributeEarthFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_earth.4bpp");
static CONST_DATA unsigned char gAttributeEarthGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_earth.4bpp");
static CONST_DATA unsigned char gAttributeEarthItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_earth.4bpp");
static CONST_DATA unsigned char gAttributeEarthSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_earth.4bpp");

static const unsigned char g808FE10[] = INCBIN_U8("graphics/cards/attributes/english_thunder.4bpp");
static CONST_DATA unsigned char gAttributeThunderFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_thunder.4bpp");
static CONST_DATA unsigned char gAttributeThunderGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_thunder.4bpp");
static CONST_DATA unsigned char gAttributeThunderItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_thunder.4bpp");
static CONST_DATA unsigned char gAttributeThunderSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_thunder.4bpp");

static const unsigned char g808FE90[] = INCBIN_U8("graphics/cards/attributes/english_aqua.4bpp");
static CONST_DATA unsigned char gAttributeAquaFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_aqua.4bpp");
static CONST_DATA unsigned char gAttributeAquaGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_aqua.4bpp");
static CONST_DATA unsigned char gAttributeAquaItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_aqua.4bpp");
static CONST_DATA unsigned char gAttributeAquaSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_aqua.4bpp");

static const unsigned char g808FF10[] = INCBIN_U8("graphics/cards/attributes/english_divine.4bpp");
static CONST_DATA unsigned char gAttributeDivineFrenchTiles[] = INCBIN_U8("graphics/cards/attributes/french_divine.4bpp");
static CONST_DATA unsigned char gAttributeDivineGermanTiles[] = INCBIN_U8("graphics/cards/attributes/german_divine.4bpp");
static CONST_DATA unsigned char gAttributeDivineItalianTiles[] = INCBIN_U8("graphics/cards/attributes/italian_divine.4bpp");
static CONST_DATA unsigned char gAttributeDivineSpanishTiles[] = INCBIN_U8("graphics/cards/attributes/spanish_divine.4bpp");

static const unsigned short TypeDragonPalette[] = INCBIN_U16("graphics/cards/types/dragon.gbapal");
static const unsigned short TypeMagicianPalette[] = INCBIN_U16("graphics/cards/types/magician.gbapal");
static const unsigned short TypeZombiePalette[] = INCBIN_U16("graphics/cards/types/zombie.gbapal");
static const unsigned short TypeWarriorPalette[] = INCBIN_U16("graphics/cards/types/warrior.gbapal");
static const unsigned short TypeBeastwarriorPalette[] = INCBIN_U16("graphics/cards/types/beast_warrior.gbapal");
static const unsigned short TypeBeastPalette[] = INCBIN_U16("graphics/cards/types/beast.gbapal");
static const unsigned short TypeWingbeastPalette[] = INCBIN_U16("graphics/cards/types/wing_beast.gbapal");
static const unsigned short TypeFiendPalette[] = INCBIN_U16("graphics/cards/types/fiend.gbapal");
static const unsigned short TypeFairyPalette[] = INCBIN_U16("graphics/cards/types/fairy.gbapal");
static const unsigned short TypeInsectPalette[] = INCBIN_U16("graphics/cards/types/insect.gbapal");
static const unsigned short TypeDinosaurPalette[] = INCBIN_U16("graphics/cards/types/dinosaur.gbapal");
static const unsigned short TypeReptilePalette[] = INCBIN_U16("graphics/cards/types/reptile.gbapal");
static const unsigned short TypeFishPalette[] = INCBIN_U16("graphics/cards/types/fish.gbapal");
static const unsigned short TypeSeadragonPalette[] = INCBIN_U16("graphics/cards/types/sea_dragon.gbapal");
static const unsigned short TypeMachinePalette[] = INCBIN_U16("graphics/cards/types/machine.gbapal");
static const unsigned short TypeThunderPalette[] = INCBIN_U16("graphics/cards/types/thunder.gbapal");
static const unsigned short TypeAquaPalette[] = INCBIN_U16("graphics/cards/types/aqua.gbapal");
static const unsigned short TypePyroPalette[] = INCBIN_U16("graphics/cards/types/pyro.gbapal");
static const unsigned short TypeRockPalette[] = INCBIN_U16("graphics/cards/types/rock.gbapal");
static const unsigned short TypePlantPalette[] = INCBIN_U16("graphics/cards/types/plant.gbapal");
static const unsigned short TypeSpellPalette[] = INCBIN_U16("graphics/cards/types/english_spell.gbapal");
static const unsigned short TypeTrapPalette[] = INCBIN_U16("graphics/cards/types/english_trap.gbapal");
static const unsigned short TypeRitualPalette[] = INCBIN_U16("graphics/cards/types/english_ritual.gbapal");

// TODO: remove "english_" prefix from file name
static const unsigned short AttributeShadowPalette[] = INCBIN_U16("graphics/cards/attributes/english_shadow.gbapal");
static const unsigned short AttributeLightPalette[] = INCBIN_U16("graphics/cards/attributes/english_light.gbapal");
static const unsigned short AttributeFiendPalette[] = INCBIN_U16("graphics/cards/attributes/english_fiend.gbapal");
static const unsigned short AttributeDreamPalette[] = INCBIN_U16("graphics/cards/attributes/english_dream.gbapal");
static const unsigned short AttributePyroPalette[] = INCBIN_U16("graphics/cards/attributes/english_pyro.gbapal");
static const unsigned short AttributeForestPalette[] = INCBIN_U16("graphics/cards/attributes/english_forest.gbapal");
static const unsigned short AttributeWindPalette[] = INCBIN_U16("graphics/cards/attributes/english_wind.gbapal");
static const unsigned short AttributeEarthPalette[] = INCBIN_U16("graphics/cards/attributes/english_earth.gbapal");
static const unsigned short AttributeThunderPalette[] = INCBIN_U16("graphics/cards/attributes/english_thunder.gbapal");
...
const unsigned short * CONST_DATA gTypeIconPalettes[] = {
  [TYPE_NONE] = g80903D0,
  [TYPE_DRAGON] = TypeDragonPalette,
  [TYPE_MAGICIAN] = TypeMagicianPalette,
  [TYPE_ZOMBIE] = TypeZombiePalette,
  [TYPE_WARRIOR] = TypeWarriorPalette,
  [TYPE_BEAST_WARRIOR] = TypeBeastwarriorPalette,
  [TYPE_BEAST] = TypeBeastPalette,
  [TYPE_WING_BEAST] = TypeWingbeastPalette,
  [TYPE_FIEND] = TypeFiendPalette,
  [TYPE_FAIRY] = TypeFairyPalette,
  [TYPE_INSECT] = TypeInsectPalette,
  [TYPE_DINOSAUR] = TypeDinosaurPalette,
  [TYPE_REPTILE] = TypeReptilePalette,
  [TYPE_FISH] = TypeFishPalette,
  [TYPE_SEA_DRAGON] = TypeSeadragonPalette,
  [TYPE_MACHINE] = TypeMachinePalette,
  [TYPE_THUNDER] = TypeThunderPalette,
  [TYPE_AQUA] = TypeAquaPalette,
  [TYPE_PYRO] = TypePyroPalette,
  [TYPE_ROCK] = TypeRockPalette,
  [TYPE_PLANT] = TypePlantPalette,
  [TYPE_SPELL] = TypeSpellPalette,
  [TYPE_TRAP] = TypeTrapPalette,
  [TYPE_RITUAL] = TypeRitualPalette
};
...
const unsigned char * CONST_DATA gTypeIconTiles[][NUM_LANGUAGES] = {
  ...
  [TYPE_DRAGON] = {
    [ENGLISH] = TypeDragonTiles,
    [FRENCH] = TypeDragonTiles,
    [GERMAN] = TypeDragonTiles,
    [ITALIAN] = TypeDragonTiles,
    [SPANISH] = TypeDragonTiles
  },
  [TYPE_MAGICIAN] = {
    [ENGLISH] = TypeMagicianTiles,
    [FRENCH] = TypeMagicianTiles,
    [GERMAN] = TypeMagicianTiles,
    [ITALIAN] = TypeMagicianTiles,
    [SPANISH] = TypeMagicianTiles
  },
  [TYPE_ZOMBIE] = {
    [ENGLISH] = TypeZombieTiles,
    [FRENCH] = TypeZombieTiles,
    [GERMAN] = TypeZombieTiles,
    [ITALIAN] = TypeZombieTiles,
    [SPANISH] = TypeZombieTiles
  },
  [TYPE_WARRIOR] = {
    [ENGLISH] = TypeWarriorTiles,
    [FRENCH] = TypeWarriorTiles,
    [GERMAN] = TypeWarriorTiles,
    [ITALIAN] = TypeWarriorTiles,
    [SPANISH] = TypeWarriorTiles
  },
  [TYPE_BEAST_WARRIOR] = {
    [ENGLISH] = TypeBeastwarriorTiles,
    [FRENCH] = TypeBeastwarriorTiles,
    [GERMAN] = TypeBeastwarriorTiles,
    [ITALIAN] = TypeBeastwarriorTiles,
    [SPANISH] = TypeBeastwarriorTiles
  },
  [TYPE_BEAST] = {
    [ENGLISH] = TypeBeastTiles,
    [FRENCH] = TypeBeastTiles,
    [GERMAN] = TypeBeastTiles,
    [ITALIAN] = TypeBeastTiles,
    [SPANISH] = TypeBeastTiles
  },
  [TYPE_WING_BEAST] = {
    [ENGLISH] = TypeWingbeastTiles,
    [FRENCH] = TypeWingbeastTiles,
    [GERMAN] = TypeWingbeastTiles,
    [ITALIAN] = TypeWingbeastTiles,
    [SPANISH] = TypeWingbeastTiles
  },
  [TYPE_FIEND] = {
    [ENGLISH] = TypeFiendTiles,
    [FRENCH] = TypeFiendTiles,
    [GERMAN] = TypeFiendTiles,
    [ITALIAN] = TypeFiendTiles,
    [SPANISH] = TypeFiendTiles
  },
  [TYPE_FAIRY] = {
    [ENGLISH] = TypeFairyTiles,
    [FRENCH] = TypeFairyTiles,
    [GERMAN] = TypeFairyTiles,
    [ITALIAN] = TypeFairyTiles,
    [SPANISH] = TypeFairyTiles
  },
  [TYPE_INSECT] = {
    [ENGLISH] = TypeInsectTiles,
    [FRENCH] = TypeInsectTiles,
    [GERMAN] = TypeInsectTiles,
    [ITALIAN] = TypeInsectTiles,
    [SPANISH] = TypeInsectTiles
  },
  [TYPE_DINOSAUR] = {
    [ENGLISH] = TypeDinosaurTiles,
    [FRENCH] = TypeDinosaurTiles,
    [GERMAN] = TypeDinosaurTiles,
    [ITALIAN] = TypeDinosaurTiles,
    [SPANISH] = TypeDinosaurTiles
  },
  [TYPE_REPTILE] = {
    [ENGLISH] = TypeReptileTiles,
    [FRENCH] = TypeReptileTiles,
    [GERMAN] = TypeReptileTiles,
    [ITALIAN] = TypeReptileTiles,
    [SPANISH] = TypeReptileTiles
  },
  [TYPE_FISH] = {
    [ENGLISH] = TypeFishTiles,
    [FRENCH] = TypeFishTiles,
    [GERMAN] = TypeFishTiles,
    [ITALIAN] = TypeFishTiles,
    [SPANISH] = TypeFishTiles
  },
  [TYPE_SEA_DRAGON] = {
    [ENGLISH] = TypeSeadragonTiles,
    [FRENCH] = TypeSeadragonTiles,
    [GERMAN] = TypeSeadragonTiles,
    [ITALIAN] = TypeSeadragonTiles,
    [SPANISH] = TypeSeadragonTiles
  },
  [TYPE_MACHINE] = {
    [ENGLISH] = TypeMachineTiles,
    [FRENCH] = TypeMachineTiles,
    [GERMAN] = TypeMachineTiles,
    [ITALIAN] = TypeMachineTiles,
    [SPANISH] = TypeMachineTiles
  },
  [TYPE_THUNDER] = {
    [ENGLISH] = TypeThunderTiles,
    [FRENCH] = TypeThunderTiles,
    [GERMAN] = TypeThunderTiles,
    [ITALIAN] = TypeThunderTiles,
    [SPANISH] = TypeThunderTiles
  },
  [TYPE_AQUA] = {
    [ENGLISH] = TypeAquaTiles,
    [FRENCH] = TypeAquaTiles,
    [GERMAN] = TypeAquaTiles,
    [ITALIAN] = TypeAquaTiles,
    [SPANISH] = TypeAquaTiles
  },
  [TYPE_PYRO] = {
    [ENGLISH] = TypePyroTiles,
    [FRENCH] = TypePyroTiles,
    [GERMAN] = TypePyroTiles,
    [ITALIAN] = TypePyroTiles,
    [SPANISH] = TypePyroTiles
  },
  [TYPE_ROCK] = {
    [ENGLISH] = TypeRockTiles,
    [FRENCH] = TypeRockTiles,
    [GERMAN] = TypeRockTiles,
    [ITALIAN] = TypeRockTiles,
    [SPANISH] = TypeRockTiles
  },
  [TYPE_PLANT] = {
    [ENGLISH] = TypePlantTiles,
    [FRENCH] = TypePlantTiles,
    [GERMAN] = TypePlantTiles,
    [ITALIAN] = TypePlantTiles,
    [SPANISH] = TypePlantTiles
  },
  [TYPE_SPELL] = {
    [ENGLISH] = TypeEnglishSpellTiles,
    [FRENCH] = TypeFrenchSpellTiles,
    [GERMAN] = TypeGermanSpellTiles,
    [ITALIAN] = TypeItalianSpellTiles,
    [SPANISH] = TypeSpanishSpellTiles
  },
  [TYPE_TRAP] = {
    [ENGLISH] = TypeEnglishTrapTiles,
    [FRENCH] = TypeFrenchTrapTiles,
    [GERMAN] = TypeGermanTrapTiles,
    [ITALIAN] = TypeItalianTrapTiles,
    [SPANISH] = TypeSpanishTrapTiles
  },
  [TYPE_RITUAL] = {
    [ENGLISH] = TypeEnglishRitualTiles,
    [FRENCH] = TypeFrenchRitualTiles,
    [GERMAN] = TypeGermanRitualTiles,
    [ITALIAN] = TypeItalianRitualTiles,
    [SPANISH] = TypeSpanishRitualTiles
  }
};

const unsigned short * CONST_DATA gAttributeIconPalettes[] = {
  [ATTRIBUTE_NONE] = g80903D0,
  [ATTRIBUTE_SHADOW] = AttributeShadowPalette,
  [ATTRIBUTE_LIGHT] = AttributeLightPalette,
  [ATTRIBUTE_FIEND] = AttributeFiendPalette,
  [ATTRIBUTE_DREAM] = AttributeDreamPalette,
  [ATTRIBUTE_PYRO] = AttributePyroPalette,
  [ATTRIBUTE_FOREST] = AttributeForestPalette,
  [ATTRIBUTE_WIND] = AttributeWindPalette,
  [ATTRIBUTE_EARTH] = AttributeEarthPalette,
  [ATTRIBUTE_THUNDER] = AttributeThunderPalette,
  [ATTRIBUTE_AQUA] = AttributeAquaPalette,
  [ATTRIBUTE_DIVINE] = AttributeDivinePalette
};
...
const unsigned char * CONST_DATA gAttributeIconTiles[][NUM_LANGUAGES] = {
  ...
  [ATTRIBUTE_SHADOW] = {
    [ENGLISH] = g808FA10,
    [FRENCH] = gAttributeShadowFrenchTiles,
    [GERMAN] = gAttributeShadowGermanTiles,
    [ITALIAN] = gAttributeShadowItalianTiles,
    [SPANISH] = gAttributeShadowSpanishTiles
  },
  [ATTRIBUTE_LIGHT] = {
    [ENGLISH] = g808FA90,
    [FRENCH] = gAttributeLightFrenchTiles,
    [GERMAN] = gAttributeLightGermanTiles,
    [ITALIAN] = gAttributeLightItalianTiles,
    [SPANISH] = gAttributeLightSpanishTiles
  },
  [ATTRIBUTE_FIEND] = {
    [ENGLISH] = g808FB10,
    [FRENCH] = gAttributeFiendFrenchTiles,
    [GERMAN] = gAttributeFiendGermanTiles,
    [ITALIAN] = gAttributeFiendItalianTiles,
    [SPANISH] = gAttributeFiendSpanishTiles
  },
  [ATTRIBUTE_DREAM] = {
    [ENGLISH] = g808FB90,
    [FRENCH] = gAttributeDreamFrenchTiles,
    [GERMAN] = gAttributeDreamGermanTiles,
    [ITALIAN] = gAttributeDreamItalianTiles,
    [SPANISH] = gAttributeDreamSpanishTiles
  },
  [ATTRIBUTE_PYRO] = {
    [ENGLISH] = g808FC10,
    [FRENCH] = gAttributePyroFrenchTiles,
    [GERMAN] = gAttributePyroGermanTiles,
    [ITALIAN] = gAttributePyroItalianTiles,
    [SPANISH] = gAttributePyroSpanishTiles
  },
  [ATTRIBUTE_FOREST] = {
    [ENGLISH] = g808FC90,
    [FRENCH] = gAttributeForestFrenchTiles,
    [GERMAN] = gAttributeForestGermanTiles,
    [ITALIAN] = gAttributeForestItalianTiles,
    [SPANISH] = gAttributeForestSpanishTiles
  },
  [ATTRIBUTE_WIND] = {
    [ENGLISH] = g808FD10,
    [FRENCH] = gAttributeWindFrenchTiles,
    [GERMAN] = gAttributeWindGermanTiles,
    [ITALIAN] = gAttributeWindItalianTiles,
    [SPANISH] = gAttributeWindSpanishTiles
  },
  [ATTRIBUTE_EARTH] = {
    [ENGLISH] = g808FD90,
    [FRENCH] = gAttributeEarthFrenchTiles,
    [GERMAN] = gAttributeEarthGermanTiles,
    [ITALIAN] = gAttributeEarthItalianTiles,
    [SPANISH] = gAttributeEarthSpanishTiles
  },
  [ATTRIBUTE_THUNDER] = {
    [ENGLISH] = g808FE10,
    [FRENCH] = gAttributeThunderFrenchTiles,
    [GERMAN] = gAttributeThunderGermanTiles,
    [ITALIAN] = gAttributeThunderItalianTiles,
    [SPANISH] = gAttributeThunderSpanishTiles
  },
  [ATTRIBUTE_AQUA] = {
    [ENGLISH] = g808FE90,
    [FRENCH] = gAttributeAquaFrenchTiles,
    [GERMAN] = gAttributeAquaGermanTiles,
    [ITALIAN] = gAttributeAquaItalianTiles,
    [SPANISH] = gAttributeAquaSpanishTiles
  },
  [ATTRIBUTE_DIVINE] = {
    [ENGLISH] = g808FF10,
    [FRENCH] = gAttributeDivineFrenchTiles,
    [GERMAN] = gAttributeDivineGermanTiles,
    [ITALIAN] = gAttributeDivineItalianTiles,
    [SPANISH] = gAttributeDivineSpanishTiles
  }
};
...
//arg0: 0 = copy opponent card gfx, 1 = copy player's, 2 = copy both
...
static void sub_800BC24(void)
{
    ...
    ConvertU16ToDigitBuffer(gCardInfo.cost, DIGIT_FLAG_NONE);
    vram = &gBgVram.cbb1[128*32];

    for (i = 0; i < 10; i++)
    {
        if (gDigitBufferU16[i - 5] == DIGIT_TERMINATOR || i < 5)
            sub_8020968(vram, 0x4081, 0x101);
        else
        {
            s32 arg1 = ((gDigitBufferU16[i - 5] + 0x824F) & 0xFF << 8) | ((gDigitBufferU16[i - 5] + 0x824F) & 0xFF00 >> 8);
...
//TODO: delete after moving this code to duel_trunk_menu.c
extern unsigned char g8DFF498[];
extern unsigned char g8DFF49B[];
extern unsigned char g8DFF49E[];
extern unsigned char g8DFF4A1[];
extern unsigned char gNextUpOptionLowLevelAnteWarningPrompt[];
extern unsigned char gNextDownOptionLowLevelAnteWarningPrompt[];
extern unsigned char g8DFF4A8[];
extern unsigned char g8DFF4AA[];
extern unsigned char g8DFF4AC[];
extern unsigned char g8DFF4AE[];
extern unsigned char g8DFF4B0[];
extern unsigned char g8DFF4B2[];
...
_0800C250: .4byte g8DFF49E\n\
_0800C254: .4byte gTrunkMenu\n\
_0800C258: .4byte g8DFF4A1\n\
...
_0800C7E8: .4byte g8DFF4B0\n\
_0800C7EC: .4byte gTrunkMenu\n\
_0800C7F0: .4byte g8DFF4B2\n\
...
void sub_800CCAC(void)
{
    ...
    for (i = 0; i < 5; i++)
      gVr.b[i + 0x5C30] = gDigitBufferU16[i] + 0x5209; //deck capacity digits
