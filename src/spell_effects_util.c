...
//This file will be auto-generated by cardjson in the future
...
// it's possible all the functions in the file are marked inline,
// but it's better to just duplicate this.
static u32 sub_805557C (u8 *arr, u16 cardId) {
