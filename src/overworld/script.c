...
static void sub_80526D0 (struct ScriptCtx* scriptCtx) {
  while (1) {
    ...
    case 1:
        ...
        break;
    case 2:
        sub_8053138(scriptCtx); //displays whatever is on unk22 buffer
        break;
    case 3:
...
static void sub_80527E8(struct ScriptCtx *script)
{
    ...
    case 0x23:
        ...
        case '3': //choose option (arrow)
            ...
            break;
        case '4':
            script->portraitId = script->currentScript.start[script->pointer + 1];
        ...
        break;
    case 0x24:
        script->pointer += GetCurrentLanguageStringOffset(&script->currentScript.start[script->pointer]);
        break;
    case 0x40:
        switch (script->currentScript.start[++script->pointer])
        {
        case '0': //duel
            ...
            if (gDuelData.winner == DUEL_WINNER_PLAYER)
            {
                ...
                script->unk1E = 1;
            script->pointer += 2;
            script->portraitId = PORTRAIT_NONE;
            break;
        case '1':
        ...
        case '6':
            ...
            script->pointer += 3;
            break;
        case '7': //move_object (arg0 = obj_id, arg1 = direction(DLUR), arg2 = distance, arg3 = wander)
            ...
            break;
        case '8':
            sub_8034FE0(); //stop sound # 0xD6 (footsteps?)
            script->pointer++;
            break;
    ...
    case 0x5E:
        switch (script->currentScript.start[++script->pointer])
        {
        case '0': //show_object (obj_id, x, y, frame, arg4, unused)
                  //arg4 = 0: instant, 1: blend, 2:drop/fall, 3:instant with shadow, 4: instant no shadow?
    ...
    case 0x7C:
        ...
        case '2': // music fade out?
            ...
            script->pointer += 2;
            break;
        case '3': //hide_portrait (and textbox?); also does an additional thing in marik's room
            script->unk86 = 0;
            sub_805339C();
            REG_WINOUT = 0x3D3E;
            OverworldSetRegDispcnt();
...
static void sub_80531FC (struct ScriptCtx* script) {
  ...
  script->unk78 = 0;
  script->unk78 += GetCurrentLanguageStringOffset(gCardInfo.name);
