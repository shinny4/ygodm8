...
enum SpellType
{
    SPELL_TYPE_NORMAL,
    SPELL_TYPE_EQUIP,
    SPELL_TYPE_INVALID //continous etc?
};
...
void SetPlayerLifePointsToSubtract(u32);
void SetOpponentLifePointsToSubtract(u32);

void ClearZone(struct DuelCard*);
void FlipCardFaceUp(struct DuelCard*);
...
void sub_803EEFC (u8, const unsigned char*, u16);
