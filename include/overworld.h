...
enum PortraitExpression {
  PORTRAIT_EXPRESSION_NEUTRAL,
  PORTRAIT_EXPRESSION_HAPPY,
  PORTRAIT_EXPRESSION_ANGRY,
  PORTRAIT_EXPRESSION_SAD,
  PORTRAIT_EXPRESSION_DEFEATED,
  PORTRAIT_EXPRESSION_CLENCHED_TEETH,
  PORTRAIT_EXPRESSION_SURPRISED,
  PORTRAIT_EXPRESSION_SWEAT_DROP,
  PORTRAIT_EXPRESSION_POSSESSED,
  PORTRAIT_EXPRESSION_CLOSED_EYES
};
...
enum Portrait {
  ...
  PORTRAIT_ISHIZU,
  PORTRAIT_SHADI,
  PORTRAIT_MIMIC_OF_DOOM,
  PORTRAIT_PANIK,
  PORTRAIT_BANDIT_KEITH,
  PORTRAIT_STRINGS,
  PORTRAIT_SEEKER,
  PORTRAIT_ARKANA,
  PORTRAIT_PARA,
  ...
  PORTRAIT_LUMIS,
  PORTRAIT_UMBRA,
  PORTRAIT_PUPPETEER_OF_DOOM,
  PORTRAIT_JEAN_CLAUDE_MAGNUM,
  PORTRAIT_ROLAND,
  PORTRAIT_DUKE,
  PORTRAIT_SERENITY,
  PORTRAIT_YAMI_MARIK,
  PORTRAIT_YAMI_BAKURA,
  PORTRAIT_PARADOX,
  PORTRAIT_NOAH,
  PORTRAIT_EVIL_JOEY,
  PORTRAIT_MONKEY_ROBOT,
  PORTRAIT_REBECCA,
  PORTRAIT_TEDDY,
  PORTRAIT_NIGHTMARE_PENGUIN,
  PORTRAIT_DEEPSEA_WARRIOR,
  PORTRAIT_ROBOTIC_KNIGHT,
  PORTRAIT_JINZO,
  PORTRAIT_JUDGE_MAN,
  PORTRAIT_MILLENNIUM_GUARDIAN,
  PORTRAIT_KAIBAMAN,
  PORTRAIT_MARIK,
  PORTRAIT_NEO_GHOUL,
  PORTRAIT_CHEVALIER,
